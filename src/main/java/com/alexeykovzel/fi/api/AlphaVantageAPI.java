package com.alexeykovzel.fi.api;

import com.alexeykovzel.fi.core.stock.Stock;
import com.alexeykovzel.fi.core.stock.StockRecord;
...
public class AlphaVantageAPI {
    ...
    private JsonNode getTimeSeriesBySymbol(String symbol) {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(String.format(FUNCTION_URL, "TIME_SERIES_WEEKLY_ADJUSTED", symbol, "data")))
